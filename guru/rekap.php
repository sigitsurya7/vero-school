<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        $sql1 = "SELECT * FROM datasiswa WHERE datasiswa.idkelas='$kelas' GROUP BY datasiswa.namasiswa ASC";
        ...
        $sql = "SELECT datasiswa.idpendaftaran, datasiswa.namasiswa, datasiswa.idkelas, card.idpendaftaran, card.uid, attendance.uid, attendance.date, attendance.status
                ...
                WHERE datasiswa.idkelas ='$kelas' AND attendance.date BETWEEN '$from' AND '$to'";
        $stmt = $db->prepare($sql);
